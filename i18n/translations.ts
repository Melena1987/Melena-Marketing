...
export const translations: Translations = {
  es: {
    ...
    contact_form_email: "Email (opcional)",
  ...
  ru: {
    ...
    contact_form_email: "Email (необязательно)",
