...
export const translations: Translations = {
  es: {
    ...
    blog_posts: [
      ...
      {
        title: 'Guía Paso a Paso: Cómo Editar Roles en tu Página de Facebook (2024)',
        excerpt: 'Gestionar los permisos de tu página de Facebook ha cambiado. Te mostramos el método actualizado para añadir administradores o editores de forma fácil y segura.',
        content: `<h2>La Nueva Experiencia de Páginas de Facebook</h2><p>Si gestionas una página de Facebook, es probable que hayas notado que la interfaz ha cambiado. La "Nueva Experiencia de Páginas" modifica la forma en que administramos los roles y permisos. Olvídate del antiguo sistema de "Administrador, Editor, Moderador...". Ahora, todo se centra en el acceso a través de Facebook o el acceso a tareas específicas.</p><p>A continuación, te explicamos el proceso actualizado para que puedas delegar tareas sin ceder más control del necesario.</p><h2>Cómo Añadir a Alguien para que Gestione tu Página</h2><p>Sigue estos sencillos pasos para dar acceso a otra persona:</p><ol class="list-decimal list-inside space-y-2"><li><strong>Ve a tu Página:</strong> Inicia sesión en Facebook y navega hasta la página que quieres gestionar.</li><li><strong>Accede al Panel para Profesionales:</strong> En la parte superior derecha de tu página, haz clic en el botón grande que dice <strong>"Gestionar"</strong>.</li><li><strong>Busca "Acceso a la página":</strong> En el menú de la izquierda, dentro del panel para profesionales, desplázate hacia abajo hasta encontrar la sección "Tus herramientas". Haz clic en <strong>"Acceso a la página"</strong>.</li><li><strong>Añade a una nueva persona:</strong> Verás dos secciones principales: "Personas con acceso a Facebook" y "Personas con acceso a tareas". Para añadir un nuevo administrador o editor, haz clic en el botón <strong>"Añadir"</strong> junto a "Personas con acceso a Facebook".</li><li><strong>Busca al usuario:</strong> Se abrirá una ventana donde podrás buscar a la persona por su nombre o dirección de correo electrónico. Selecciónala de la lista.</li><li><strong>Asigna el nivel de control:</strong> Aquí viene la parte más importante. Se te preguntará qué permisos quieres conceder. Si activas la opción <strong>"Permitir que esta persona también tenga el control total"</strong>, le estarás dando un rol de administrador completo. Podrá eliminar la página o eliminar a otros administradores (incluyéndote a ti). Si no activas esta opción, la persona tendrá un rol similar al de un editor, pudiendo crear contenido, responder mensajes y ver estadísticas, pero sin poder realizar cambios drásticos en la página.</li><li><strong>Confirma con tu contraseña:</strong> Por seguridad, Facebook te pedirá que introduzcas tu contraseña para confirmar la acción.</li></ol><p>¡Y listo! La persona recibirá una invitación que deberá aceptar en un plazo de 30 días para obtener el acceso. Asegúrate de añadir solo a personas de confianza, especialmente si concedes el control total.</p>`
      },
      {
  ...
  en: {
    ...
    blog_posts: [
      ...
      {
        title: 'Step-by-Step Guide: How to Edit Page Roles on Facebook (2024)',
        excerpt: 'Managing your Facebook Page permissions has changed. We show you the updated method to add admins or editors easily and securely.',
        content: `<h2>The New Facebook Pages Experience</h2><p>If you manage a Facebook page, you've likely noticed that the interface has changed. The "New Pages Experience" modifies how we manage roles and permissions. Forget the old system of "Admin, Editor, Moderator...". Now, everything is centered on access through Facebook or access to specific tasks.</p><p>Below, we explain the updated process so you can delegate tasks without giving up more control than necessary.</p><h2>How to Add Someone to Manage Your Page</h2><p>Follow these simple steps to give access to another person:</p><ol class="list-decimal list-inside space-y-2"><li><strong>Go to Your Page:</strong> Log in to Facebook and navigate to the page you want to manage.</li><li><strong>Access the Professional Dashboard:</strong> In the upper right corner of your page, click the large button that says <strong>"Manage"</strong>.</li><li><strong>Find "Page Access":</strong> In the left-hand menu within the professional dashboard, scroll down until you find the "Your Tools" section. Click on <strong>"Page Access"</strong>.</li><li><strong>Add a New Person:</strong> You will see two main sections: "People with Facebook access" and "People with task access". To add a new admin or editor, click the <strong>"Add New"</strong> button next to "People with Facebook access".</li><li><strong>Search for the User:</strong> A window will open where you can search for the person by their name or email address. Select them from the list.</li><li><strong>Assign the Control Level:</strong> This is the most important part. You will be asked what permissions you want to grant. If you enable the option <strong>"Allow this person to have full control"</strong>, you are giving them a full administrator role. They will be able to delete the page or remove other admins (including you). If you do not enable this option, the person will have a role similar to an editor, able to create content, respond to messages, and view insights, but without the ability to make drastic changes to the page.</li><li><strong>Confirm with Your Password:</strong> For security, Facebook will ask you to enter your password to confirm the action.</li></ol><p>And that's it! The person will receive an invitation that they must accept within 30 days to gain access. Be sure to only add people you trust, especially if you grant full control.</p>`
      },
      {
  ...
  ru: {
    ...
    blog_posts: [
      ...
      {
        title: 'Пошаговое руководство: Как редактировать роли на странице Facebook (2024)',
        excerpt: 'Управление разрешениями на вашей странице Facebook изменилось. Мы покажем вам обновленный метод простого и безопасного добавления администраторов или редакторов.',
        content: `<h2>Новый интерфейс страниц Facebook</h2><p>Если вы управляете страницей в Facebook, вы, вероятно, заметили, что интерфейс изменился. «Новый интерфейс страниц» меняет способ управления ролями и разрешениями. Забудьте о старой системе «Администратор, Редактор, Модератор...». Теперь все сосредоточено на доступе через Facebook или доступе к конкретным задачам.</p><p>Ниже мы объясняем обновленный процесс, чтобы вы могли делегировать задачи, не передавая больше контроля, чем необходимо.</p><h2>Как добавить кого-то для управления вашей страницей</h2><p>Следуйте этим простым шагам, чтобы предоставить доступ другому человеку:</p><ol class="list-decimal list-inside space-y-2"><li><strong>Перейдите на свою страницу:</strong> Войдите в Facebook и перейдите на страницу, которой вы хотите управлять.</li><li><strong>Откройте Панель для профессионалов:</strong> В правом верхнем углу вашей страницы нажмите большую кнопку с надписью <strong>«Управление»</strong>.</li><li><strong>Найдите «Доступ к странице»:</strong> В меню слева в панели для профессионалов прокрутите вниз до раздела «Ваши инструменты». Нажмите на <strong>«Доступ к странице»</strong>.</li><li><strong>Добавьте нового человека:</strong> Вы увидите два основных раздела: «Люди с доступом к Facebook» и «Люди с доступом к задачам». Чтобы добавить нового администратора или редактора, нажмите кнопку <strong>«Добавить»</strong> рядом с «Люди с доступом к Facebook».</li><li><strong>Найдите пользователя:</strong> Откроется окно, где вы сможете найти человека по имени или адресу электронной почты. Выберите его из списка.</li><li><strong>Назначьте уровень контроля:</strong> Это самая важная часть. Вас спросят, какие разрешения вы хотите предоставить. Если вы включите опцию <strong>«Разрешить этому человеку также иметь полный контроль»</strong>, вы предоставите ему полные права администратора. Он сможет удалить страницу или удалить других администраторов (включая вас). Если вы не включите эту опцию, у человека будет роль, похожая на роль редактора: он сможет создавать контент, отвечать на сообщения и просматривать статистику, но не сможет вносить кардинальные изменения на страницу.</li><li><strong>Подтвердите своим паролем:</strong> В целях безопасности Facebook попросит вас ввести свой пароль для подтверждения действия.</li></ol><p>Вот и все! Человек получит приглашение, которое он должен принять в течение 30 дней, чтобы получить доступ. Убедитесь, что вы добавляете только доверенных лиц, особенно если предоставляете полный контроль.</p>`
      },
      {
