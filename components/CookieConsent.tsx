...
const CookieConsent: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl bg-blue-800/95 backdrop-blur-sm text-white rounded-lg shadow-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex-shrink-0 bg-yellow-400 text-blue-800 font-bold py-2 px-6 rounded-full text-sm hover:bg-yellow-500 transition duration-300 ease-in-out transform hover:scale-105"
        >
          {t.cookie_accept}
        </button>
      </div>
