...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, title }) => {
  ...
  return (
    <div className={`aspect-square ${bgColor} ${textColor} flex items-center justify-center p-4 transform hover:scale-105 hover:shadow-2xl transition-transform duration-300 ease-in-out`}>
