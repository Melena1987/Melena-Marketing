      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 bg-gray-50 p-8 rounded-lg shadow-xl">
          <div>
            ...
            >
              <img 
                src="https://firebasestorage.googleapis.com/v0/b/melenamarketing-a6e61.firebasestorage.app/o/recursos%2FManu_Melena_Marketing.png?alt=media&token=3f6f330a-66aa-4573-86a7-78bbab7934d1"
